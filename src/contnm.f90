...
!        5911-5917, (1996).                                             
!                                                                       
!        Only calculate if V2 > 2085. cm-1 and V1 <  2670. cm-1         
!                                                                       
...
!           amagat is in units of amagats (air)                         
!                                                                       
!           The temperature correction of the absorption coefficient is 
!           done in subroutine n2_ver_1:                                
!                                                                       
...
!                                                                       
     ...
     &     '   mt_ckd_2.5 - increase 2000-3200 cm-1  (Jan 2010)',       &
     &     '            AIR           0 - 20000 CM-1           ',       &
     &     '   mt_ckd_2.4 - modify far-ir and MW     (Nov 2008)',       &
